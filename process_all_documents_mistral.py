...
class ProductionMetabolicProcessor:
    ...
    async def extract_with_mistral(self, content: str, metadata: Dict) -> List[Dict]:
        ...
        try:
            ...
            prompt = f"""Extract entities from this document using Regen Network Unified Ontology v1.0.

METABOLIC TYPES (Core Classes):
- regen:Agent (people, organizations, AI agents)
- regen:SemanticAsset (documents, proposals, knowledge)
- regen:EcologicalAsset (carbon credits, ecological resources, MRV data)
- regen:GovernanceAct (votes, decisions, policies)
- regen:MetabolicFlow (processes, data flows, value flows)

DISCOURSE TYPES (Extension Classes):
- regen:Question (inquiries, research questions)
- regen:Hypothesis (testable predictions)
- regen:Claim (assertions, statements)
- regen:Evidence (data, results, observations)
- regen:Source (references, experiments)
- regen:Theory (well-substantiated explanations)
- regen:Model (frameworks, representations)
...
JSON array:"""
            ...
            for i, entity in enumerate(entities):
                if isinstance(entity, dict):
                    ...
                    entity['extractedBy'] = 'mistral-processor-v1'
