-- Migration 040: KOI-net Protocol Tables
-- Date: 2026-02-23
-- Purpose: Event queue, edge profiles, node registry, and peer aliases for KOI-net federation
...
-- Peer aliases for human-friendly name resolution (e.g., "share with shawn")
CREATE TABLE IF NOT EXISTS koi_net_peer_aliases (
    id SERIAL PRIMARY KEY,
    alias VARCHAR(100) NOT NULL UNIQUE,
    node_rid TEXT NOT NULL REFERENCES koi_net_nodes(node_rid),
    created_at TIMESTAMPTZ DEFAULT NOW()
);
