-- Migration 047: Commons intake metadata for shared documents
--
-- Adds recipient_type and intake review fields so commons nodes can stage
-- inbound shares for manual approval/rejection before ingestion.
