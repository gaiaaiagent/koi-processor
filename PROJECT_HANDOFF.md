...
- **Are `Protocol`/`Project` TYPES or FACETS?** Gates migration 113's shape. Task 9315. `allowed_facets` exists with an FK and a shape CHECK — zero rows, zero users.
