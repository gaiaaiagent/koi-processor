...
4. *(structural, unscheduled)* **Ontology generator (audit D4b)** — generate the extraction prompt enum from `allowed_entity_types`. Resolves the 518 remaining Concept-absorption tasks as a side effect; hand-triage spends the effort twice.
